...
DATABASE_CONFIG = {
    ...
    'intervar_20180118': {
        'file': 'hg38_intervar_20180118.txt.gz',
        'type': 'filter',
        'operation': 'f',
        'format': 'generic',
    ...
    'gnomad211_exome': {
        'file': 'hg38_gnomad211_exome.txt.gz',
        'type': 'filter',
        'operation': 'f',
        'format': 'generic',
        'columns': ['AF', 'AF_popmax', 'AF_male', 'AF_female', 'AF_raw', 'AF_afr', 'AF_sas', 'AF_amr', 'AF_eas', 'AF_nfe', 'AF_fin', 'AF_asj', 'AF_oth', 'non_topmed_AF_popmax', 'non_neuro_AF_popmax', 'non_cancer_AF_popmax', 'controls_AF_popmax'],
        'data_start_col': 5,
        'has_chr_prefix': False,
    },
    'gnomad30_genome': {
        'file': 'hg38_gnomad30_genome.txt.gz',
        'type': 'filter',
        'operation': 'f',
        'format': 'generic',
        'columns': ['AF', 'AF_raw', 'AF_male', 'AF_female', 'AF_afr', 'AF_ami', 'AF_amr', 'AF_asj', 'AF_eas', 'AF_fin', 'AF_nfe', 'AF_oth', 'AF_sas'],
        'data_start_col': 5,
        'has_chr_prefix': True,
    },
    'snp141': {
    ...
    'ljb26_all': {
        ...
        'operation': 'f',
        'format': 'generic',
        'columns': ['SIFT_score', 'SIFT_pred', 'Polyphen2_HDIV_score', 'Polyphen2_HDIV_pred', 'Polyphen2_HVAR_score', 'Polyphen2_HVAR_pred', 'LRT_score', 'LRT_pred', 'MutationTaster_score', 'MutationTaster_pred', 'MutationAssessor_score', 'MutationAssessor_pred', 'FATHMM_score', 'FATHMM_pred', 'RadialSVM_score', 'RadialSVM_pred', 'LR_score', 'LR_pred', 'VEST3_score', 'CADD_raw', 'CADD_phred', 'GERP++_RS', 'phyloP46way_placental', 'phyloP100way_vertebrate', 'SiPhy_29way_logOdds'],
        'data_start_col': 5,
        'has_chr_prefix': False,
    },
    'clinvar_20220730': {
        'file': 'hg38_clinvar_20220730.txt.gz',
        'type': 'filter',
        'operation': 'f',
        'format': 'generic',
...
DATABASE_ORDER = [
    ...
    'intervar_20180118', 'kaviar_20150923', 'mcap', 'revel',
    'gnomad211_exome', 'gnomad30_genome',
    'snp141', 'ljb26_all', 'clinvar_20220730',
    'cosmic',
